            ...
            <div class="card shadow-lg border-0 rounded-lg mt-5">
                <div class="card-body p-5">
                    <div class="text-center mb-4">
                        ...
                        <h1 class="display-4 mt-3 mb-2">¡Ups! Página no encontrada</h1>
                        <p class="lead text-muted">La página que estás buscando no existe o ha sido movida.</p>
                    </div>
                    ...
                    <div class="text-center mt-5">
                        <p class="text-muted mb-0">¿Necesitas ayuda? Contacta al administrador del sistema.</p>
                    </div>
                </div>
            </div>
        </div>
